...
<form action="{{route('user.booking.edit.update')}}" method="POST">
    @csrf
        ...
        <div class="card d-lg-flex justify-content-lg-center" style="margin: 0px;margin-top: 41px;margin-bottom: 12px;">
            ...
            <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" id="start_date" name="start_date" value="{{session('start_date')}}">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="startTime" class="col-sm-2 col-form-label">Start time</label>
                      <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" id="start_time" name="start_time" value="{{session('start_time')}}">
                      </div>
                    </div>
                    <div class="form-group row">
                        <label for="endDate" class="col-sm-2 col-form-label">End date</label>
                        <div class="col-sm-10">
                          <input type="text" readonly class="form-control-plaintext" id="end_date" name="end_date"  value="{{session('end_date')}}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="endTime" class="col-sm-2 col-form-label">End time</label>
                        <div class="col-sm-10">
                          <input type="text" readonly class="form-control-plaintext" id="end_time" name="end_time" value="{{session('end_time')}}">
                        </div>
                      </div>
                      <div class="form-group row">
