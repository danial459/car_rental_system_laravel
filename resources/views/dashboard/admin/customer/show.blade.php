...
<div class="d-flex flex-column">
    ...
    <div class="col-sm-12 col-md-8 col-lg-8 col-xl-4 shadow p-4 rounded bg-white js-active mt-5 ">
        ...
        <div class="form-row mt-4 ">
            <div class="form-group col-12 col-sm-12 border rounded">
...
<div class="table-responsive" >
    ...
    <div class="text-center">
        ...
        <small class="text-muted">This customer booked these cars.</small>
  </div>
  ...
  <tbody>
    @forelse($books as $book)
      ...
      <tr id="tr-id-1" class="tr-class-1" data-title="bootstrap table" data-object='{"key": "value"}'>
        ...
        <td><a href="{{route('admin.car.plateNo.show',['no_plate' => $book->no_plate])}}" target="_blank">{{$book->no_plate}}</a></td>
