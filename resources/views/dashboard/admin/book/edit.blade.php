                            ...
                            <div id="form-content" class="multisteps-form__content">
                                <div id="input-grp-double" class="form-row mt-4">
                                    <div class="form-group col-12 col-sm-6">
                                        ...
                                        <input type="date" class="form-control " name="start_date" value="{{$book->start_date}}"/>
                                    </div>
                                    <div class="form-group col-12 col-sm-6 mt-4 mt-sm-0">
                                        <label class="label-control">Start time</label>
                                        <input type="time" class="form-control " name="start_time" value="{{$book->start_time}}"/>
                                    </div>
                                </div>
                                <div id="input-grp-double" class="form-row mt-4">
                                    <div class="form-group col-12 col-sm-6">
                                        <label class="label-control">End date</label>
                                        <input type="date" class="form-control " name="end_date" value="{{$book->end_date}}"/>
                                    </div>
                                    <div class="form-group col-12 col-sm-6 mt-4 mt-sm-0">
                                        <label class="label-control">End time</label>
                                        <input type="time" class="form-control " name="end_time" value="{{$book->end_time}}"/>
                                    </div>
                                </div>
                                <div id="input-grp-double" class="form-row mt-4">
                                    ...
                                    <div class="form-group col-12 col-sm-6 mt-4 mt-sm-0 form-check form-check-radio">
                                        ...
                                        <textarea type="text" id="pickupvalue" class="form-control form-control-lg" style=" font-size: 0.875em" onclick="pickup()" >{{$book->pick_up}}</textarea>
                                    </div>
                                </div>
                                <div id="input-grp-single" class="form-row mt-4">
                                    <div class="col-12"><input class="form-control multisteps-form__input" type="text" name="note" placeholder="Note(Optional)" value="{{$book->note}}"></div>
                                </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                      @foreach ( $cars as $car )
                        <tr>
                            <td>{{$car->no_plate}}</td>
                            <td><img src='{{ asset('/images/'.$car->link.'.jpg') }}' alt="car"></td>
                            <td>{{$car->car_name}}</td>
                            <td>{{$car->rate}}</td>
                            <td>
